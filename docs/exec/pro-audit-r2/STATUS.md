...
| WP3 | Overflow bucket, exact maximum and split subscribe clocks implemented. Held ACK at 100/160/500 ms and diagnostic trace A/B pass. The 13 × 3 benchmark matrix passed on local macOS and hosted Linux at `975e35a`. | Compare platform variance and rerun against the final frozen source. |
